...
//        GlideApp.with(VerifyFingerActivity.this).load(R.mipmap.ic_launcher).transforms(new BitmapCircleTransformation(VerifyFingerActivity.this)).into(iv_finger_icon);
        Glide.with(VerifyFingerActivity.this).load(R.mipmap.ic_launcher).into(iv_finger_icon);
    ...
    private void initVerify() {
        mFingerprintIdentify.startIdentify(4, new BaseFingerprint.FingerprintIdentifyListener() {
            ...
            public void onSucceed() {
                Intent intent = new Intent(VerifyFingerActivity.this,VerifyActivity.class);
                startActivity(intent);
                finish();
            }
