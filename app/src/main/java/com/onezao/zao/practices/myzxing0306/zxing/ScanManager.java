package com.onezao.zao.practices.myzxing0306.zxing;
...
import com.onezao.zao.practices.myzxing0306.zxing.camera.CameraManager;
import com.onezao.zao.practices.myzxing0306.zxing.decode.DecodeThread;
import com.onezao.zao.practices.myzxing0306.zxing.decode.PhotoScanHandler;
import com.onezao.zao.practices.myzxing0306.zxing.decode.RGBLuminanceSource;
import com.onezao.zao.practices.myzxing0306.zxing.utils.BeepManager;
import com.onezao.zao.practices.myzxing0306.zxing.utils.BitmapUtil;
import com.onezao.zao.practices.myzxing0306.zxing.utils.CaptureActivityHandler;
import com.onezao.zao.practices.myzxing0306.zxing.utils.InactivityTimer;
...
/*				//获取图片长度高度尺寸
				...
				BitmapFactory.decodeFile(photo_path2, opts);
				// 从Options中获取图片的分辨率
				int imageHeight = opts.outHeight;
				int imageWidth = opts.outWidth;*/

				BitmapFactory.Options opts = BitmapUtil.getPicOptions(photo_path2);
				// 从Options中获取图片的分辨率
				int imageHeight = opts.outHeight;
				int imageWidth = opts.outWidth;

//				Bitmap bitmap= BitmapUtil.decodeBitmapFromPath(photo_path2,600,600);
				Bitmap bitmap= BitmapUtil.decodeBitmapFromPath(photo_path2,imageWidth,imageHeight);
