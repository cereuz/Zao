package com.onezao.zao.practices.viewpager0306;
...
//		viewPager.setOffscreenPageLimit(1);// 左右各保留几个对象
        ...
        private void initData() {
            ...
            // 图片资源id数组
            imageResIds = new int[]{R.mipmap.ic_tab_group_active, R.mipmap.ic_tab_home_active, R.mipmap.ic_tab_profile_active, R.mipmap.ic_tab_status_active, R.mipmap.ic_tab_home_normal};
